...
type ServiceContainerInterface interface {
	...
	GetInitOptions() *models.InitOptions
...
type SegmentationManagerInterface interface {
	SetContextualData(serviceContainer ServiceContainerInterface, feature *campaign.Feature, context *user.WingifyUserContext)
