...
import (
	...
	globalEnums "github.com/wingify/wingify-fme-go-sdk/pkg/enums"
	log_messages "github.com/wingify/wingify-fme-go-sdk/pkg/log_messages"
	...
	"github.com/wingify/wingify-fme-go-sdk/pkg/packages/logger/transports"
...
func (lm *LogManager) Error(template string, templateData map[string]interface{}, extraData map[string]interface{}, shouldSendDebugEvent ...bool) {
	...
	if len(shouldSendDebugEvent) == 0 {
		utils.SendDebugEventToWingify(lm.settingsManager, debugEventProps)
	}
}
