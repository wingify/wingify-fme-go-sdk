...
const (
	...
	// SDKVersion is shared across host profiles (wire protocol unchanged).
	SDKVersion = "1.50.0"
	...
	// API endpoints (paths only; hosts come from pkg/brand)
	SettingsEndpoint        = "/server-side/v2-settings"
	WebhookSettingsEndpoint = "/server-side/v2-pull"

	// Environment and protocol
	FsEnvironment = "vwo_fs_environment"
	HTTPSProtocol = "https"
	HTTPProtocol  = "http"

	// Algorithm and meta constants
	RandomAlgo                  = 1
	WingifyMetaMegKey           = "_vwo_meta_meg_"
	VariationTargetingUserIDKey = "_wingifyUserId"
