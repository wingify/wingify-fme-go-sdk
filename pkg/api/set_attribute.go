...
// SetAttribute sets user attributes and sends an impression to Wingify
func SetAttribute(attributeMap map[string]interface{}, context *user.WingifyUserContext, serviceContainer interfaces.ServiceContainerInterface) {
...
func createAndSendImpressionForSetAttribute(
	...
	properties := utils.GetEventsBaseProperties(
		...
		enums.SyncVisitorProp.GetValue(),
