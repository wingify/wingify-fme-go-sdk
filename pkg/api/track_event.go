...
func TrackEvent(eventName string, context *user.WingifyUserContext, eventProperties map[string]interface{}, serviceContainer interfaces.ServiceContainerInterface) bool {
